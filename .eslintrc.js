module.exports = {
    ...
    rules: {
      ...
      "@typescript-eslint/no-explicit-any": 'off', //리턴 any허용여부
      "@typescript-eslint/explicit-module-boundary-types": 'off' //param any허용여부
    ...
    //   'no-multiple-empty-lines': [ 'error', { 'max': 2, 'maxEOF': 2 }], // 허용되는 빈 줄 개수
